...
class Product(models.Model):
    ...
    image = ResizedImageField(size=[400, 500], crop=['top', 'left'],quality=100, upload_to='', default='noimage.png')
    image_2 = ResizedImageField(size=[400, 500], crop=['top', 'left'],quality=100, upload_to='', default='noimage.png')
