...
class Product(models.Model):
    ...
    image = ResizedImageField(size=[400, 500], crop=['middle', 'center'],quality=100, upload_to='', default='noimage.jpeg')
    image_2 = ResizedImageField(size=[400, 500], crop=['middle', 'center'],quality=100, upload_to='', default='noimage.jpeg', null=True)
